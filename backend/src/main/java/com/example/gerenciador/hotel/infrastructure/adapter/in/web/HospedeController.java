...
public class HospedeController {
    ...
    private final HospedeUseCase hospedeUseCase;
    ...
    public ResponseEntity<HospedeResponseDTO> getHospedeByCpf(@PathVariable String cpf) {
        Hospede hospede = hospedeUseCase.buscarHospedePorCpf(cpf);
    ...
    public ResponseEntity<EnderecoResponseDTO> criaEnderecoHospede(
        ...
        Endereco enderecoSalvo = hospedeUseCase.criarEnderecoParaHospede(cpf, enderecoMapper.toDomain(dto));
    ...
    public ResponseEntity<EnderecoResponseDTO> getEnderecoHospedeByCpf(@PathVariable String cpf) {
        Endereco endereco = hospedeUseCase.buscarEnderecoHospedePorCpf(cpf);
